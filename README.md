...
**Live → https://baditaflorin.github.io/mesh-mic-drop-quiz/**

**Source → https://github.com/baditaflorin/mesh-mic-drop-quiz**
...
git clone https://github.com/baditaflorin/mesh-mic-drop-quiz
cd mesh-mic-drop-quiz
npm install
npm run dev
```
...
- `mesh-mic-drop-quiz:signalingUrl`
- `mesh-mic-drop-quiz:turnTokenUrl`
- `mesh-mic-drop-quiz:iceServers`
- `mesh-mic-drop-quiz:room`
